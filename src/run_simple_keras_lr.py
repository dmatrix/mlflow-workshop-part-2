...
X_fahrenheit = np.array(
   [-140, -136, -124, -112, -105, -96, -88, -75, -63, -60,
    ...
    99,105, 110, 120, 135, 145, 158, 160, 165, 170, 175, 180, 185, 187, 190, 195, 198], dtype=float)
...
y_celsius = np.array(
   [-95.55, -93.33, -86.66, -80, -76.11, -71.11, -66.66, -59.44, -52.77, -51.11,
    ...
    71.11, 73.88, 76.66, 79.44, 82.22, 85, 86.11,87.77,90.55, 92.22], dtype=float)
...
if __name__ == '__main__':
   ...
   df = pd.DataFrame(np.array([32, 212, 200, 205]))
